...
export const COMPANY_CATALOG: CatalogCompany[] = [
  ...
  c('D05.SI', 'DBS Group Holdings Ltd', 'SGX', 'Banking', 'Singapore', '$100B', 'https://logo.clearbit.com/dbs.com?size=128'),
  c('O39.SI', 'Oversea-Chinese Banking Corporation', 'SGX', 'Banking', 'Singapore', '$70B', 'https://logo.clearbit.com/ocbc.com?size=128'),
  c('U11.SI', 'United Overseas Bank Limited', 'SGX', 'Banking', 'Singapore', '$45B', 'https://logo.clearbit.com/uobgroup.com?size=128'),
  c('C6L.SI', 'Singapore Airlines Limited', 'SGX', 'Airlines', 'Singapore', '$18B', 'https://logo.clearbit.com/singaporeair.com?size=128'),
  c('BN4.SI', 'Keppel Ltd', 'SGX', 'Diversified Industrials', 'Singapore', '$12B', 'https://logo.clearbit.com/keppel.com?size=128'),
  c('9CI.SI', 'CapitaLand Investment Limited', 'SGX', 'Real Estate', 'Singapore', '$16B', 'https://logo.clearbit.com/capitaland.com?size=128'),
  c('C38U.SI', 'CapitaLand Integrated Commercial Trust', 'SGX', 'REIT', 'Singapore', '$10B', 'https://logo.clearbit.com/cict.com.sg?size=128'),
  c('A17U.SI', 'CapitaLand Ascendas REIT', 'SGX', 'REIT', 'Singapore', '$11B', 'https://logo.clearbit.com/capitalandascendasreit.com?size=128'),
  c('N2IU.SI', 'Mapletree Pan Asia Commercial Trust', 'SGX', 'REIT', 'Singapore', '$8B', 'https://logo.clearbit.com/mapletree.com.sg?size=128'),
  c('M44U.SI', 'Mapletree Logistics Trust', 'SGX', 'REIT', 'Singapore', '$7B', 'https://logo.clearbit.com/mapletree.com.sg?size=128'),
  c('S68.SI', 'Singapore Exchange Limited', 'SGX', 'Financial Infrastructure', 'Singapore', '$11B', 'https://logo.clearbit.com/sgx.com?size=128'),
  c('F34.SI', 'Wilmar International Limited', 'SGX', 'Consumer Goods', 'Singapore', '$10B', 'https://logo.clearbit.com/wilmar-international.com?size=128'),
  c('5E2.SI', 'SATS Ltd', 'SGX', 'Aviation Services', 'Singapore', '$6B', 'https://logo.clearbit.com/sats.com.sg?size=128'),
  c('C52.SI', 'ComfortDelGro Corporation Limited', 'SGX', 'Transport', 'Singapore', '$5B', 'https://logo.clearbit.com/comfortdelgro.com?size=128'),
  c('S63.SI', 'Singapore Technologies Engineering Ltd', 'SGX', 'Industrial Technology', 'Singapore', '$18B', 'https://logo.clearbit.com/stengg.com?size=128'),
  c('C07.SI', 'Jardine Cycle & Carriage Limited', 'SGX', 'Industrials', 'Singapore', '$9B', 'https://logo.clearbit.com/jccl.com.sg?size=128'),
  c('J36.SI', 'Jardine Matheson Holdings Limited', 'SGX', 'Diversified Holdings', 'Singapore', '$15B', 'https://logo.clearbit.com/jardines.com?size=128'),
  c('G13.SI', 'Genting Singapore Limited', 'SGX', 'Leisure / Gaming', 'Singapore', '$8B', 'https://logo.clearbit.com/gentingsingapore.com?size=128'),
  c('H78.SI', 'Hongkong Land Holdings Limited', 'SGX', 'Real Estate', 'Singapore', '$13B', 'https://logo.clearbit.com/hongkongland.com?size=128'),
  c('S59.SI', 'Sembcorp Industries Ltd', 'SGX', 'Utilities / Energy', 'Singapore', '$13B', 'https://logo.clearbit.com/sembcorp.com?size=128'),
  c('C09.SI', 'City Developments Limited', 'SGX', 'Real Estate', 'Singapore', '$7B', 'https://logo.clearbit.com/cdl.com.sg?size=128'),
  c('U14.SI', 'UOL Group Limited', 'SGX', 'Real Estate', 'Singapore', '$6B', 'https://logo.clearbit.com/uol.com.sg?size=128'),
  c('S08.SI', 'Singapore Post Limited', 'SGX', 'Logistics', 'Singapore', '$1B', 'https://logo.clearbit.com/singpost.com?size=128'),
  c('CC3.SI', 'StarHub Ltd', 'SGX', 'Telecommunications', 'Singapore', '$1B', 'https://logo.clearbit.com/starhub.com?size=128'),
  c('VC2.SI', 'Olam Group Limited', 'SGX', 'Consumer Goods', 'Singapore', '$3B', 'https://logo.clearbit.com/olamgroup.com?size=128'),
  c('YF8.SI', 'Yangzijiang Financial Holding Ltd', 'SGX', 'Financial Services', 'Singapore', '$4B', 'https://logo.clearbit.com/yangzijiangfinancial.com?size=128'),
  c('BS6.SI', 'Yangzijiang Shipbuilding Holdings Ltd', 'SGX', 'Industrials', 'Singapore', '$12B', 'https://logo.clearbit.com/yzjship.com?size=128'),
  c('C31.SI', 'CapitaLand China Trust', 'SGX', 'REIT', 'Singapore', '$2B', 'https://logo.clearbit.com/capitalandchina.com?size=128'),
  c('J69U.SI', 'Frasers Centrepoint Trust', 'SGX', 'REIT', 'Singapore', '$10B', 'https://logo.clearbit.com/frasersproperty.com?size=128'),
  c('ME8U.SI', 'Mapletree Industrial Trust', 'SGX', 'REIT', 'Singapore', '$6B', 'https://logo.clearbit.com/mapletree.com.sg?size=128'),
  c('K71U.SI', 'Keppel DC REIT', 'SGX', 'REIT', 'Singapore', '$5B', 'https://logo.clearbit.com/keppeldcreit.com?size=128'),
  c('J91U.SI', 'CapitaLand Ascott Trust', 'SGX', 'Hospitality REIT', 'Singapore', '$3B', 'https://logo.clearbit.com/ascott.com?size=128'),
  c('A7RU.SI', 'ESR-LOGOS REIT', 'SGX', 'Industrial REIT', 'Singapore', '$2B', 'https://logo.clearbit.com/esr.com?size=128'),
  c('C2PU.SI', 'Frasers Logistics & Commercial Trust', 'SGX', 'REIT', 'Singapore', '$3B', 'https://logo.clearbit.com/frasersproperty.com?size=128'),
  c('T82U.SI', 'Suntec REIT', 'SGX', 'REIT', 'Singapore', '$4B', 'https://logo.clearbit.com/suntecreit.com?size=128'),
  c('B58.SI', 'Banyan Tree Holdings Limited', 'SGX', 'Hospitality', 'Singapore', '$1B', 'https://logo.clearbit.com/banyantree.com?size=128'),
  c('F10.SI', 'Haw Par Corporation Limited', 'SGX', 'Consumer Goods', 'Singapore', '$3B', 'https://logo.clearbit.com/hawpar.com?size=128'),
  c('O9E.SI', 'NetLink NBN Trust', 'SGX', 'Telecommunications Infrastructure', 'Singapore', '$2B', 'https://logo.clearbit.com/netlinknbn.com?size=128'),
  c('C61U.SI', 'CDL Hospitality Trusts', 'SGX', 'Hospitality REIT', 'Singapore', '$2B', 'https://logo.clearbit.com/cdlht.com?size=128'),
]
